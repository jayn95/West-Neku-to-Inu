    ...
    <div class="main_body">
      ...
      <div class="sidebar_menu">
        ...
        <div class="animal_container">
            ...
            <form id="profile_form" style="display: none;" method="POST" enctype="multipart/form-data">
                ...
                <button class="submit-button" type="button" id="save_profile_btn" onclick="saveData()">Save</button>
